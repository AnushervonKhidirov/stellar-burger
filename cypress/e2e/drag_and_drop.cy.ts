...
describe('drag and drop testing', () => {
    ...
    it('visit my site', () => {
		...
		cy.get(`[data-testid='constructor_block']`).trigger('drop')
			.get(`[data-testid='ingredient_item-643d69a5c3f7b9001cfa093c']`).should('exist')
		

		cy.get(`[data-testid='ingredient_item-643d69a5c3f7b9001cfa0940']`).trigger('dragstart')
		cy.get(`[data-testid='constructor_block']`).trigger('drop')
			.get(`[data-testid='ingredient_item-643d69a5c3f7b9001cfa0940']`).should('exist')

		cy.get(`[data-testid='ingredient_item-643d69a5c3f7b9001cfa093e']`).trigger('dragstart')
		cy.get(`[data-testid='constructor_block']`).trigger('drop')
			.get(`[data-testid='ingredient_item-643d69a5c3f7b9001cfa093e']`).should('exist')

		cy.get(`[data-testid='constructor_ingredient-643d69a5c3f7b9001cfa093e'] .constructor-element__action`).click()
